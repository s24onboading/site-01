...
## Environments
- Preview: https://main--site-01--s24onboading.hlx.page/
- Live: https://main--site-01--s24onboading.hlx.live/
- Custom Domain: https://site-01.playground.name (Available during the lab)
...
WKND_URL=https://main--site-01--s24onboading.hlx.live ITERATIONS=1000 npm run generate-traffic
```
